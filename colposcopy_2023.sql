...
CREATE TABLE `accessi` (
  ...
  `ip_access` varchar(16) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Struttura della tabella `accessi_users`
--

CREATE TABLE `accessi_users` (
  `id_accesso` int(11) NOT NULL,
...
--
-- Indici per le tabelle `accessi_users`
--
ALTER TABLE `accessi_users`
  ADD PRIMARY KEY (`id_accesso`),
  ADD KEY `user` (`user`);
...
--
ALTER TABLE `accessi`
  MODIFY `id_accesso` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `accessi_users`
--
ALTER TABLE `accessi_users`
  MODIFY `id_accesso` int(11) NOT NULL AUTO_INCREMENT;
